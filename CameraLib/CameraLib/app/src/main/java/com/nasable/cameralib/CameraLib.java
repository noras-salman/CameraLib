...
/* The afro mentioned code has been modified by Noras Salman
*  and can be used under the same licence and conditions with mentioning my own contribution */
...
public class CameraLib {
    ...
    public CameraLib(Activity activity,AutoFitTextureView textureView,OnPictureTakenListener onPictureTakenListener){
